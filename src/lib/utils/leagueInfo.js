k/*   STEP 1   */
export const leagueID = "1124852596587126784"; // your league ID
export const leagueName = "Utah Valley Fantasy"; // your league name
...
export const homepageText = `
  <p>Welcome to the Utah Valley Fantasy league page! Providing digitally induced anxiety since 2008.</p>
`;
...
export const managers = [
    {
      ...
      "photo": "/managers/jacksmirk.webp", // square ratio recommended (no larger than 500x500)
